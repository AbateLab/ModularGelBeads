...
class seq_experiment(object):
    ...
    def process_barcodes(self, R1_file, R2_file, handle, verbose=True, cleanup=True, rev_complement_s2 = False):
        ...
        cutadapt_command = 'cutadapt -g CCTATTCGAG -A CCTATTCGAG -o {} -p {} {} {} -q 20 -e 0.075 -O 9 -j 3 --discard-untrimmed'.format(
                            _name+'_read.fastq.gz', _name+'_bc.fastq.gz', R1_file, R1_file)
